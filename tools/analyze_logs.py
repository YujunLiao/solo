...
def plot_curve(log_dicts, args):
    ...
    if legend is None:
        ...
        for json_log in args.json_logs:
            for metric in args.keys:
                json_log = os.path.basename(json_log)
    ...
    if args.out is None:
        ...
        # print(args.json_logs)
        dir = os.path.dirname(args.json_logs[0])
        plt.savefig(f'{dir}/{args.out}')
        print(f"save curve to: {dir}/{args.out}")
